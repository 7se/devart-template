...
public class FunctionView3 extends View{
	...
	Paint paint;
	public FunctionView3(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	
		this.Init();
	}
	public FunctionView3(Context context)
	{
		super(context);
		this.Init();
	}
	...
	public void Start()
	{
		...
		this.timer.schedule(new TimerTask() {
			...
			public void run() {
				...
				FunctionView3.this.ChangeAlpha(count);
				FunctionView3.this.postInvalidate();
			}
		}, 0,30);
	}
